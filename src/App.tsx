...
const logoSvg = `<svg xmlns="http://www.w3.org/2000/svg" width="512" height="512" viewBox="0 0 512 512"><defs><filter id="glow" x="-20%" y="-20%" width="140%" height="140%"><feGaussianBlur stdDeviation="10" result="blur" /><feComposite in="SourceGraphic" in2="blur" operator="over" /></filter></defs><rect width="512" height="512" rx="96" fill="#050505"/><rect width="512" height="512" rx="96" fill="#3b82f6" fill-opacity="0.15"/><rect width="504" height="504" x="4" y="4" rx="92" fill="none" stroke="#3b82f6" stroke-opacity="0.4" stroke-width="8"/><g transform="translate(128, 128) scale(10.666)" filter="url(#glow)"><path d="M12 8V4H8" fill="none" stroke="#3b82f6" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><rect width="16" height="12" x="4" y="8" rx="2" fill="none" stroke="#3b82f6" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><path d="M2 14h2" fill="none" stroke="#3b82f6" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><path d="M20 14h2" fill="none" stroke="#3b82f6" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><path d="M15 13v2" fill="none" stroke="#3b82f6" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><path d="M9 13v2" fill="none" stroke="#3b82f6" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></g></svg>`;
